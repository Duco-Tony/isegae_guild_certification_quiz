...
import { QuizState, TrackWeights } from './lib/types';
...
const testAnswers1: QuizState = ['q1_a', 'q2_d', 'q3_b', 'q4_c', 'q5_a', 'q6_a', 'q7_a'];
...
const equalScores: TrackWeights = {
  AI: 10,
  Cloud: 10,
  Data: 5,
  Security: 5,
...
situations.slice(0, 3).forEach(q1 => {
  tracks.slice(0, 3).forEach(track => {
    const persona = getPersona(q1, track as any);
...
const testCases = [
  { track: 'Cloud' as const, coding: 'none' as const, situation: 'jobseeker' as const, time: 'fast' as const },
  { track: 'Cloud' as const, coding: 'advanced' as const, situation: 'itWorker' as const, time: 'deep' as const },
  { track: 'Data' as const, coding: 'none' as const, situation: 'nonIT' as const, time: 'moderate' as const },
  { track: 'PowerPlatform' as const, coding: 'advanced' as const, situation: 'itWorker' as const, time: 'deep' as const }
];
...
const originalAnswers: QuizState = ['q1_a', 'q2_b', 'q3_c', 'q4_d', 'q5_e', 'q6_f', 'q7_g'];
...
const testWithNegative1: QuizState = ['q1_a', 'q2_a', 'q3_a', 'q4_a', 'q5_g', 'q6_a', 'q7_a'];
